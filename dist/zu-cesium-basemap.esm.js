 ...
 * @Date: 2022-07-20 14:11:20
 * @LastEditors: zulezhe
 * @LastEditTime: 2022-07-20 15:28:11
 * @Path: https://gitee.com/zulezhe/
 * @Description: 
 */
...
class OSMImageryProvider extends Cesium.OpenStreetMapImageryProvider {
  ...
  constructor(options) {
    ...
    super({
      url: options.type === 'vec_dark' ? DARK_URL : VEC_URL,
      subdomains: ["a", "b", "c", "d"]
    });
  }
...
export { AmapImageryProvider, ArcgisImageryProvider, BmapImageryProvider, GeoqImageryProvider, GoogleImageryProvider, MapboxImageryProvider, OSMImageryProvider, TdtImageryProvider };
